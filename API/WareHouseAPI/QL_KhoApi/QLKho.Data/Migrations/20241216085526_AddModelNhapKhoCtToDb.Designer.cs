...
namespace QLKho.Data.Migrations
{
    ...
    [Migration("20241216085526_AddModelNhapKhoCtToDb")]
    partial class AddModelNhapKhoCtToDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QLKho.Models.Domain.Kho", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QLKho.Models.Domain.NhaCC", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QLKho.Models.Domain.NhapKho", b =>
                {
            ...
            modelBuilder.Entity("QLKho.Models.Domain.NhapKhoCT", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QLKho.Models.Domain.NhomSanPham", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QLKho.Models.Domain.SanPham", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QLKho.Models.Domain.NhapKho", b =>
                {
                    b.HasOne("QLKho.Models.Domain.Kho", "Kho")
                        .WithMany()
                        .HasForeignKey("kho_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QLKho.Models.Domain.NhaCC", "Ncc")
                        .WithMany()
            ...
            modelBuilder.Entity("QLKho.Models.Domain.NhapKhoCT", b =>
                {
                    b.HasOne("QLKho.Models.Domain.NhapKho", "NhapKho")
                        .WithMany()
                        .HasForeignKey("nhap_kho_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QLKho.Models.Domain.SanPham", "SanPham")
                        .WithMany()
            ...
            modelBuilder.Entity("QLKho.Models.Domain.SanPham", b =>
                {
                    b.HasOne("QLKho.Models.Domain.NhomSanPham", "NhomSanPham")
                        .WithMany()
